    ...
    <div className="flex flex-col h-full bg-slate-800/50 rounded-lg">
        ...
        <div className="p-4 border-b border-slate-700 bg-slate-800">
            ...
            <div className="flex items-center pl-2 sm:pl-4 pr-4 py-2 bg-slate-900 rounded-t-lg border-b-2 border-science-500">
                 ...
                 <div className="ml-6 text-sm font-bold text-science-400 uppercase tracking-widest hidden sm:block">
                     Guide Reference
                 </div>
            </div>
        </div>
            ...
            {hits.length > 0 ? (
                ...
                <div className="absolute inset-0 flex items-center justify-center p-6">
                    <EmptyState 
                        ...
                        description="Try relaxing your filters to see more off-targets."
